...
from motionnet.models.qcnet.modules import QCNetDecoder
from motionnet.models.qcnet.modules import QCNetEncoder
...
class QCNet(pl.LightningModule):
    ...
    def __init__(self,
        ...
        self.output_head = config.get('output_head')
        self.num_historical_steps = config.get('num_historical_steps')
        self.num_future_steps = config.get('num_future_steps')
        self.num_modes = config.get('num_modes')
        self.num_recurrent_steps = config.get('num_recurrent_steps')
        self.num_freq_bands = config.get('num_freq_bands')
        self.num_map_layers = config.get('num_map_layers')
        self.num_agent_layers = config.get('num_agent_layers')
        self.num_dec_layers = config.get('num_dec_layers')
        self.num_heads = config.get('num_heads')
        self.head_dim = config.get('head_dim')
        self.dropout = config.get('dropout')
        self.pl2pl_radius = config.get('pl2pl_radius')
        self.time_span = config.get('time_span')
        self.pl2a_radius = config.get('pl2a_radius')
        self.a2a_radius = config.get('a2a_radius')
        self.num_t2m_steps = config.get('num_t2m_steps')
        self.pl2m_radius = config.get('pl2m_radius')
        self.a2m_radius = config.get('a2m_radius')
        self.lr = config.get('lr')
        self.weight_decay = config.get('weight_decay')
        self.T_max = config.get('T_max')
        self.submission_dir = config.get('submission_dir')
        self.submission_file_name = config.get('submission_file_name')
