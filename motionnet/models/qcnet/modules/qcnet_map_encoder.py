...
from motionnet.models.qcnet.utils import merge_edges
...
class QCNetMapEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        # Define of the embeddings to use
