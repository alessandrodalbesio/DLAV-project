...
from motionnet.utils import safe_list_index
from motionnet.utils import side_to_directed_lineseg
...
class QCNetDataset(Dataset):
    ...
    def __init__(self,
        ...
        super(QCNetDataset, self).__init__(root=root, transform=transform, pre_transform=None, pre_filter=None)
